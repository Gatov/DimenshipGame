...
/// <summary>
/// What is being dragged: either a part pulled off the palette, or the part already sitting in a
/// socket being moved out of it.
/// <para>
...
{
    /// <summary>The part being dragged. Always set — there is nothing else to drag here.</summary>
    public required PartDef Part { get; init; }

    /// <summary>
    /// The socket this came out of, or null when it came off the palette. What tells a drop
    /// whether it is fitting a new part or moving one, and therefore whether the source socket
    ...
    public bool Fits(SocketKind kind) => Part.Kind == kind;
}
