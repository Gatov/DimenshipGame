...
| :--- | :--- | :--- | :--- |
| 1 — Shell layout model | Complete, review clean | `fb6988c` | 9 |
| 2 — Simulation kernel | Fix round 2 of 5 open | `e0b8dac`, `d15981a`, `ea24e8d` | 34 |
| 3 — Driver and entry point | Not started | — | — |
| 4 — Palette and theme | Not started | — | — |
| 5 — Panel infrastructure | Not started | — | — |
| 6 — The three real panels | Not started | — | — |
...
- Task 7 expected 27 tests on the assumption of two pre-existing `GameInfoTests`. There is one. Corrected to 26.
...
- [ ] **Step 1: Add the Shell reference to the Godot project**
...
- [ ] **Step 2: Write the simulation driver**
...
- [ ] **Step 4: Write the minimal shell root**
...
- [ ] **Step 6: Repoint the start screen**
...
- [ ] **Step 7: Delete the placeholder game scene**
...
- [ ] **Step 9: Verify both libraries reach the Godot output**
...
- [ ] **Step 2: Write the theme builder**
...
- [ ] **Step 3: Apply the theme in ShellRoot**
...
- [ ] **Step 1: Write the panel base, context, and actions**
...
- [ ] **Step 2: Write the registry and the placeholder panel**
...
- [ ] **Step 1: Write the overview focus view**
...
- [ ] **Step 2: Write the energy budget panel**
...
- [ ] **Step 4: Swap the three placeholder registrations for the real panels**
...
Expected: `Failed: 0`. Total is 26 tests — 1 pre-existing `GameInfoTests`, 10 `UnitsTests`, 13 `SimulationEngineTests`, 8 `LayoutSerializerTests`. If the count differs, a test was lost; find it before continuing.
...
Do not mark any visual behaviour verified. Report exactly this state: the solution builds, 27 tests pass, and no scene has ever been opened by Godot. Ask the user to open `C:\Work\DimenshipGame\dimenship\project.godot` in Godot 4.7.1-mono and press F5.
